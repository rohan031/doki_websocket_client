...
abstract class $UserCreateRootNodeCopyWith<$Res> {
  ...
  @useResult
  $Res call({String from, String id, NodeType nodeType, PayloadType type});
}
...
class _$UserCreateRootNodeImpl implements _UserCreateRootNode {
  ...
  @override
  String toString() {
    return 'UserCreateRootNode(from: $from, id: $id, nodeType: $nodeType, type: $type)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, from, id, nodeType, type);
